...
\begin{frame}
    \summaryslide{Euer Tutor: Daniel Baur}
...
\begin{frame}
    \summaryslide{Vielen Dank für Eure Aufmerksamkeit!}
    \begin{textblock*}{2\paperwidth}(0.0\paperwidth,0.0\paperheight)
        \vspace*{2.0cm}
        \hspace*{1.0cm}
    ...
    \end{textblock*}
    \AddToShipoutPictureBG*{\put(0.22\paperwidth,-0.013\paperheight){\includegraphics[width=0.54\paperwidth]{./images/feedback_qr_code_2021.png}}}
    \framenumbersummaryslide
\end{frame}
